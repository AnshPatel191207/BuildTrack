...
export const flatBodySchema = z.object({
  ...
  superBuiltupAreaSqft: z.number().nonnegative().optional(),
  plotAreaSqmt: z.number().nonnegative().optional(),
  builtUpAreaSqmt: z.number().nonnegative().optional(),
  carpetAreaSqmt: z.number().nonnegative().optional(),
  balconyAreaSqmt: z.number().nonnegative().optional(),
  terraceAreaSqmt: z.number().nonnegative().optional(),
  saleDeedAmount: z.number().nonnegative().optional(),
...
export const unitUpdateBodySchema = z.object({
  unitNumber: z.string().min(1).max(30).optional(),
  unitType: z.string().min(1).max(40).optional(),
  category: z.enum(['flat', 'shop', 'office', 'penthouse', 'plot']).optional(),
  areaSqft: z.number().nonnegative().optional(),
  carpetAreaSqft: z.number().nonnegative().optional(),
  builtUpAreaSqft: z.number().nonnegative().optional(),
  superBuiltupAreaSqft: z.number().nonnegative().optional(),
  ...
  ratePerSqft: z.number().nonnegative().optional(),
  parkingSlot: z.string().max(60).nullable().optional(),
  parkingCharges: z.number().nonnegative().optional(),
  clubhouseCharges: z.number().nonnegative().optional(),
  gstPercentage: z.number().nonnegative().max(28).optional(),
  basePrice: z.number().nonnegative().optional(),
